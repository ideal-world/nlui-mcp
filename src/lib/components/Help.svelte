<script lang="ts">
	...
	import type { NLUITableComponentProps } from '../ui/components/table.types.js';
	...
	const basicTableData: NLUITableComponentProps = {
		...
		columns: [
			{ key: 'id', title: 'ID', align: 'center', width: '80px', sortable: true },
			{ key: 'name', title: 'Name', align: 'left', sortable: true },
		...
		rows: [
			{
				...
				actions: [
					{ label: 'Edit', variant: 'outline', onClickLink: '#' },
					{ label: 'Delete', variant: 'secondary', onClickLink: '#' }
				]
			},
			{
				id: 2,
				...
				actions: [
					{ label: 'Edit', variant: 'outline', onClickLink: '#' },
					{ label: 'Activate', variant: 'primary', onClickLink: '#' }
				]
			},
			{
				id: 3,
	...
	const simpleTableData: NLUITableComponentProps = {
		columns: [
			{ key: 'product', title: 'Product', align: 'left' },
