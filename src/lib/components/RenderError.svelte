	...
	<div class="mx-auto max-w-4xl">
		...
		<div class="bg-base-100 mx-auto max-w-2xl rounded-lg p-6 shadow-lg">
			<div class="mb-6 text-center">
				<div
					class="text-error bg-error/10 mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full"
				>
				...
				<div class="mb-6">
					<details class="collapse-arrow bg-base-200 collapse">
						...
						<div class="collapse-content">
							<pre
								class="text-error bg-base-100 max-h-40 overflow-auto rounded p-3 text-sm">{errorDetails}</pre>
						</div>
					</details>
				</div>
			{/if}
